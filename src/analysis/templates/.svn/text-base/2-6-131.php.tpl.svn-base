...
<col  width="175">
    ...
    <tr>
        ...
        <td class="Value" colspan="3">{$form.f_check25.html}</td>
    </tr>
...
<table class="List_Table" border="1" width="100%">
    ...
    <tr class="Result1">
        ...
        <td align="left">新規契約<br>増設金額<br>減少金額<br>合計</td></td>
    ...
    <tr class="Result3">
        ...
        <td align="left"><b>新規契約<br>増設金額<br>減少金額<br>合計</td></td>
    ...
    <tr class="Result4">
        ...
        <td align="left"><b>新規契約<br>増設金額<br>減少金額<br>合計</td>
