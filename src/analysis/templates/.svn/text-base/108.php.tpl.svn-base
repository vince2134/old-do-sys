{*
 *
 * 担当者別商品別売上推移（本部、FC）（template）
 *
 *
 * 履歴：
 *
 *  日付        担当者          内容
 *  2007-10-13  fukuda-sss      新規作成
 *              kajioka-h       FC画面の場合、検索条件に所属本支店と部署を追加
 *
 *}
...
<col width="300px">
    ...
    <tr>
        ...
        <td class="Value" colspan="3">{$form.form_staff.html}</td>
    </tr>
    {* FC画面の場合、所属本支店と部署を表示 *}
        ...
        {********** 合計行専用 ここから **********}
            ...
            {if $smarty.foreach.data.first OR $smarty.foreach.data.last}
                ...
                <tr class="Result4">
                    ...
                    <td align="center" class="bold">{$disp_data[$last].total_count}人</td>
                    <td></td>                     
                    <td class="bold">
                        売上金額<br>
                        粗利益額<br>
