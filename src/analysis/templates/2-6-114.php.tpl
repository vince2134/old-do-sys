...
<table class="Data_Table" border="1" width="650" >
    ...
    <tr>
        <td class="Title_Gray"width="110"><b>担当者名</b></td>
        <td class="Value" colspan="3">{$form.f_select21.html}</td>
    </tr>
...
<table class="List_Table" border="1" width="100%">
    <tr align="center">
        ...
        <td class="Title_Gray" width=""><b>売上金額</b></td>
    ...
    <tr class="Result1">
        ...
        <td align="left" rowspan="9">担当者A</td>
    ...
    <tr class="Result1">
        ...
        <td align="left" rowspan="9">担当者B</td>
        <td align="left">商品5</td>
        <td align="right">3,500</td>
        <td align="right">34.70%</td></td>
        <td align="right">3,500</td>
