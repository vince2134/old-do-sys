<?php /* Smarty version 2.6.14, created on 2010-04-05 15:58:17
         compiled from 108.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'Plug_Minus_Numformat', '108.php.tpl', 199, false),array('modifier', 'Plug_Unit_Add', '108.php.tpl', 203, false),array('modifier', 'escape', '108.php.tpl', 249, false),)), $this); ?>
...
<col width="300px">
 ...
 ¤«¤é <?php echo $this->_tpl_vars['form']['form_trade_ym_e']['html']; ?>
    ...
    <tr>
        ...
        <td class="Value" colspan="3"><?php echo $this->_tpl_vars['form']['form_staff']['html']; ?>
</td>
    </tr>
        <?php if ($_SESSION['group_kind'] !== '1'): ?>
    <tr>
        <td class="Title_Gray">½êÂ°ËÜ»ÙÅ¹</td>
    ...
    <tr>
        ...
        <?php if ($_SESSION['group_kind'] === '1'): ?>
    <tr>
        <td class="Title_Gray">Ãê½ÐÂÐ¾Ý</td>
