<?php /* Smarty version 2.6.14, created on 2010-05-22 20:13:41
...
<table  class="List_Table" border="1" width="400" >
	...
	<tr class="Result3">
		...
		<td class="Value" align="center"><?php echo $this->_tpl_vars['form']['button']['csvf20']['html']; ?>
</td>
	</tr>
	...
	<tr class="Result3">
		...
		<td class="Value" align="center"><?php echo $this->_tpl_vars['form']['button']['csvf30']['html']; ?>
</td>
	</tr>
