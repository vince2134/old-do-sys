<?php /* Smarty version 2.6.14, created on 2010-05-22 20:10:49
...
<col align="center">
    ...
    <tr class="Result3">
        ...
        <td class="Value"><?php echo $this->_tpl_vars['form']['button']['csvh20']['html']; ?>
</td>
    </tr>
    <tr class="Result3">
        <td>売上推移</td>
    ...
    <tr class="Result3">
        ...
        <td class="Value"><?php echo $this->_tpl_vars['form']['button']['csvh29']['html']; ?>
</td>
    </tr>
    <tr class="Result3">
