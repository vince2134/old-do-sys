<?php /* Smarty version 2.6.14, created on 2010-04-05 15:58:22
         compiled from 112.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'Plug_Minus_Numformat', '112.php.tpl', 118, false),array('modifier', 'escape', '112.php.tpl', 141, false),array('modifier', 'Plug_Unit_Add', '112.php.tpl', 147, false),)), $this); ?>
...
<br><?php echo ((is_array($_tmp=$this->_tpl_vars['disp_data'][$this->_tpl_vars['i']]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <!-- 本部の場合 -->
        <?php if ($this->_tpl_vars['var']['group_kind'] == '1'): ?>
            <td ><?php echo $this->_tpl_vars['disp_data'][$this->_tpl_vars['i']]['rank_cd']; ?>
<br><?php echo $this->_tpl_vars['disp_data'][$this->_tpl_vars['i']]['rank_name']; ?>
</td>
        <?php endif; ?>
...
" bgcolor="<?php echo $this->_tpl_vars['disp_data'][$this->_tpl_vars['i']]['bgcolor']; ?>
">
