...
require_once(FNC_PATH."html.fnc");
...
require_once(FNC_PATH."analysis_query.fnc");    
require_once(FNC_PATH."analysis_data_edit.fnc");
require_once(FNC_PATH."analysis_data_edit_ABC.fnc");
require_once(FNC_PATH."analysis_query_ABC.fnc");    
require_once(FNC_PATH."analysis.fnc");
require_once(FNC_PATH."form.fnc");
require_once(FNC_PATH."view.fnc");
