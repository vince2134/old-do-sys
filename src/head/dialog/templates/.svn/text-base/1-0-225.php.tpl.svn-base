...
<col width="35" align="center">
    ...
    <tr>
        <td class="left">{$ary_h_mod_data[5][1][1][1][4]}</td>
        <td>{$form.permit.h.6.2.5.r.html}</td>
        <td>{$form.permit.h.6.2.5.w.html}</td>
    </tr>

    <tr>
        <td class="left_bottom">{$ary_h_mod_data[5][1][1][1][5]}</td>
        <td class="bottom">{$form.permit.h.6.2.6.r.html}</td>
        <td class="bottom">{$form.permit.h.6.2.6.w.html}</td>
    </tr>
    {* マスタ・設定 - 個別マスタ *}
    <tr>
...
<col width="35" align="center">
    ...
    <tr>
        <td class="left">{$ary_f_mod_data[5][1][1][1][4]}</td>
        <td>{$form.permit.f.6.2.5.r.html}</td>
        <td>{$form.permit.f.6.2.5.w.html}</td>
    </tr>
    <tr>
        <td class="left_bottom">{$ary_f_mod_data[5][1][1][1][5]}</td>
        <td class="bottom">{$form.permit.f.6.2.6.r.html}</td>
        <td class="bottom">{$form.permit.f.6.2.6.w.html}</td>
    </tr>
