...
$account_name   = trim($_POST["form_account_name"]);    // 口座名義
...
//    $client_sql .= "    t_client.state = '1' ";
    ...
    $client_sql .= "        WHEN '2' THEN '解約・休止中' ";
    $client_sql .= "    END AS state, ";
    $client_sql .= "    CASE t_client.close_day ";
    ...
    $client_sql .= "     t_client.client_div = '3' ";
    $client_sql .= "AND ";
    $client_sql .= "     t_rank.group_kind IN ('2', '3') ";
    $client_sql .= $where_sql;
    $client_sql .= $turn_sql;
...
for($i = 0; $i < $match_count; $i++){
    ...
    //請求データ作成    
        ...
        $return_data[] = $return.",'".$page_data[$i][8]."'";
