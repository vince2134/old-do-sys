<?php /* Smarty version 2.6.14, created on 2010-05-12 20:48:35
         compiled from 1-4-105.php.tpl */ ?>
...
<?php if ($this->_tpl_vars['var']['error'] != null): ?><li><?php echo $this->_tpl_vars['var']['error']; ?>
<br><?php endif; ?>
</span>
...
<col>
        ...
        <tr>
            ...
            <td class="Value" width="250"><?php echo $this->_tpl_vars['form']['form_goods_cname']['html']; ?>
</td>
        </tr>
        <tr>
...
<br><a href="1-4-114.php?ware_id=<?php echo $this->_tpl_vars['row'][$this->_tpl_vars['j']][3]; ?>
...
&start=<?php echo $this->_tpl_vars['var']['hand_start']; ?>
&end=<?php echo $this->_tpl_vars['var']['hand_end']; ?>
&trans_flg=3"><?php echo $this->_tpl_vars['row'][$this->_tpl_vars['j']][2]; ?>
</a></td>
        <?php endif; ?>
