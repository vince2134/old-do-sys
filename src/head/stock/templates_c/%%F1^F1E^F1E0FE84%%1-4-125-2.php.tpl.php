<?php /* Smarty version 2.6.9, created on 2006-09-19 13:35:49
         compiled from 1-4-125-2.php.tpl */ ?>
...
<table  class="Data_Table" border="1" width="650" >
	...
	<tr>
		...
		<td class="Value" colspan="3"><?php echo $this->_tpl_vars['form']['form_situation']['html']; ?>
</td>
	</tr>

	<tr>
		<td class="Title_Yellow" width="100"><b>出荷番号</b></td>
		<td class="Value" ><?php echo $this->_tpl_vars['form']['form_ship_num']['html']; ?>
</td>
	...
	<tr>
		<td class="Title_Yellow" width="100"><b>出荷日</b></td>
		<td class="Value" ><?php echo $this->_tpl_vars['form']['form_ship_day']['html']; ?>
</td>
		<td class="Title_Yellow" width="100"><b>申請日</b></td>
		<td class="Value" ><?php echo $this->_tpl_vars['form']['form_appli_day']['html']; ?>
</td>
	</tr>

	<tr>
		<td class="Title_Yellow" width="100"><b>出荷倉庫</b></td>
		<td class="Value" ><?php echo $this->_tpl_vars['form']['form_ware']['html']; ?>
</td>
		<td class="Title_Yellow" width="100"><b>申請元</b></td>
		<td class="Value" ><?php echo $this->_tpl_vars['form']['form_appli']['html']; ?>
</td>
	</tr>
...
<table class="List_Table" border="1" width="100%">
	<tr align="center">
		...
		<td class="Title_Yellow" width=""><b>出荷数</b></td>
	</tr>
...
　　<?php echo $this->_tpl_vars['form']['form_correct']['html']; ?>
</td>
	</tr>
</table>
