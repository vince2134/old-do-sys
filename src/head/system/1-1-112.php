...
//登録ボタン
$button[] = $form->createElement("submit","touroku","登　録","onClick=\"javascript: return Dialogue('登録します。','#', this)\"");
//クリアボタン
$button[] = $form->createElement("button","clear","クリア","onClick=\"javascript: return Button_Submit('clear_flg','#','true', this)\"");
//戻るボタン
