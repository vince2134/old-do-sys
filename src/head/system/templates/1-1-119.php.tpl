            ...
            <table>
                <tr>
                    ...
                    <td><font color="#555555">
                        &nbsp;指定なし<br>
                        (1)&nbsp;{$form.form_abcd_week1.html}&nbsp;週&nbsp;{$form.form_week_rday1.html}&nbsp;曜日<br>
                        (2)&nbsp;毎月{$form.form_rday1.html}日<br>
                        (3)&nbsp;毎月第&nbsp;{$form.form_cale_week1.html}&nbsp;{$form.form_week_rday2.html}&nbsp;曜日<br>
                        (4)&nbsp;基準日&nbsp;{$form.form_stand_day4_1.html}&nbsp;&nbsp;{$form.form_cale_mon4_1.html}&nbsp;ヶ月おきの第&nbsp;{$form.form_cale_week2.html}&nbsp;{$form.form_cale_day4_1.html}&nbsp;曜日<br>
                        (5)&nbsp;基準日&nbsp;{$form.form_stand_day5_1.html}&nbsp;&nbsp;{$form.form_cale_mon5_1.html}&nbsp;ヶ月おきの&nbsp;{$form.form_f_cale_day5_1.html}&nbsp;日<br>
                        (6)&nbsp;基準日&nbsp;{$form.form_stand_day6_1.html}&nbsp;&nbsp;{$form.form_week_num6_1.html}&nbsp;週おきの&nbsp;{$form.f_cale_day6_1.html}&nbsp;曜日<br>
                        (7)&nbsp;変則日
                    </td>
                </tr>
            </table>
        ...
        <td class="Value">
            <table>
                <tr>
                    ...
                    <td><font color="#555555">
                        &nbsp;変更しない<br>
                        (1)&nbsp;{$form.form_abcd_week2.html}&nbsp;週&nbsp;{$form.form_week_rday3.html}&nbsp;曜日<br>
                        (2)&nbsp;毎月{$form.form_rday1.html}日<br>
                        (3)&nbsp;毎月第&nbsp;{$form.form_cale_week3.html}&nbsp;{$form.form_week_rday3.html}&nbsp;曜日<br>
                        (4)&nbsp;基準日&nbsp;{$form.form_stand_day4_2.html}&nbsp;&nbsp;{$form.form_cale_mon4_2.html}&nbsp;ヶ月おきの第&nbsp;{$form.form_cale_week3.html}&nbsp;{$form.form_cale_day4_2.html}&nbsp;曜日<br>
                        (5)&nbsp;基準日&nbsp;{$form.form_stand_day5_2.html}&nbsp;&nbsp;{$form.form_cale_mon5_2.html}&nbsp;ヶ月おきの&nbsp;{$form.form_f_cale_day5_2.html}&nbsp;日<br>
                        (6)&nbsp;基準日&nbsp;{$form.form_stand_day6_2.html}&nbsp;&nbsp;{$form.form_week_num6_2.html}&nbsp;週おきの&nbsp;{$form.f_cale_day6_2.html}&nbsp;曜日<br>
