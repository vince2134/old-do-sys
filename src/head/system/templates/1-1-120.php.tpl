...
<col width="35" align="center">
    ...
    <tr>    
        ...
        <td bgcolor="#e0e0f0" class="top_left" colspan="2">{$ary_h_mod_data[3][1][0][0]}</td>
        <td bgcolor="#e0e0f0" class="bottom">{$form.permit.h.4.1.0.r.html}</td>
        <td bgcolor="#e0e0f0" class="bottom">{$form.permit.h.4.1.0.w.html}</td>
    </tr>   
    <tr>    
        <td bgcolor="#e0e0f0" class="left_bottom" rowspan="{$var.h_submenu_rowspan[3][0]}"></td>
        <td class="top_left">{$ary_h_mod_data[3][1][0][1][0]}</td>
        <td>{$form.permit.h.4.1.1.r.html}</td>
        <td>{$form.permit.h.4.1.1.w.html}</td>
    </tr>   
    <tr>    
        <td class="left">{$ary_h_mod_data[3][1][0][1][1]}</td>
        <td>{$form.permit.h.4.1.2.r.html}</td>
        <td>{$form.permit.h.4.1.2.w.html}</td>
    </tr>   
    <tr>    
        <td class="left">{$ary_h_mod_data[3][1][0][1][2]}</td>
        <td>{$form.permit.h.4.1.3.r.html}</td>
        <td>{$form.permit.h.4.1.3.w.html}</td>
    </tr>   
    <tr>    
        <td class="left">{$ary_h_mod_data[3][1][0][1][3]}</td>
        <td>{$form.permit.h.4.1.4.r.html}</td>
        <td>{$form.permit.h.4.1.4.w.html}</td>
    </tr>   
    <tr>    
        <td class="left_bottom">{$ary_h_mod_data[3][1][0][1][4]}</td>
        <td class="bottom">{$form.permit.h.4.1.5.r.html}</td>
        <td class="bottom">{$form.permit.h.4.1.5.w.html}</td>
    </tr> 
    {* データ出力 *}
    <tr>
    ...
    <tr>
        <td class="left_bottom">{$ary_h_mod_data[5][1][2][1][10]}</td>
        <td class="bottom">{$form.permit.h.6.3.11.r.html}</td>
        <td class="bottom">{$form.permit.h.6.3.11.w.html}</td>
    </tr>
    {* マスタ・設定 - 帳票設定 *}
    <tr>
    ...
    <tr>
        <td class="left_bottom">{$ary_h_mod_data[5][1][3][1][3]}</td>
        <td class="bottom">{$form.permit.h.6.4.4.r.html}</td>
        <td class="bottom">{$form.permit.h.6.4.4.w.html}</td>
    </tr>
    {* マスタ・設定 - システム設定 *}
    <tr>
