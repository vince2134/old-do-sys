...
if ($h_change_ng_flg != true){
    $form->addElement("submit", "form_set_button", "設　定", "
        onClick=\"javascript:Button_Submit_1('set_permit_flg', './1-1-109.php?staff_id=$staff_id', 'true');\"
        $disabled
    ");
}
...
$form->addElement("button", "form_return_button", "戻　る", "
    onClick=\"javascript:Button_Submit_1('permit_rtn_flg', './1-1-109.php?staff_id=$staff_id', 'true');\"
");
