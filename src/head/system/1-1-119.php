...
$text5_1[] =& $form->createElement("text","f_text2","テキストフォーム","size=\"2\" maxLength=\"2\" style=\"text-align: left\" ".$g_form_option."\"");
...
$text5_2[] =& $form->createElement("text","f_text2","テキストフォーム","size=\"2\" maxLength=\"2\" ".$g_form_option."\"");
...
$text[] =& $form->createElement("text","m","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day4_1[m]','form_stand_day4_1[d]',2)\" ".$g_form_option."\"");
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","d","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day4_1[d]','form_cale_mon4_1',2)\" ".$g_form_option."\"");
$form->addGroup($text,"form_stand_day4_1","form_stand_day4_1");

$form->addElement("text","form_cale_mon4_1","テキストフォーム","size=\"2\" maxLength=\"2\" ".$g_form_option."\"");
...
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","m","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day4_2[m]','form_stand_day4_2[d]',2)\" ".$g_form_option."\"");
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","d","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day4_2[d]','form_cale_mon4_2',2)\" ".$g_form_option."\"");
$form->addGroup($text,"form_stand_day4_2","form_stand_day4_2");

$form->addElement("text","form_cale_mon4_2","テキストフォーム","size=\"2\" maxLength=\"2\" ".$g_form_option."\"");
...
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","m","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day5_1[m]','form_stand_day5_1[d]',2)\" ".$g_form_option."\"");
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","d","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day5_1[d]','form_cale_mon5_1',2)\" ".$g_form_option."\"");
$form->addGroup($text,"form_stand_day5_1","form_stand_day5_1");

$form->addElement("text","form_cale_mon5_1","テキストフォーム","size=\"2\" maxLength=\"2\" ".$g_form_option."\"");
...
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","m","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day5_2[m]','form_stand_day5_2[d]',2)\" ".$g_form_option."\"");
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","d","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day5_2[d]','form_cale_mon5_2',2)\" ".$g_form_option."\"");
$form->addGroup($text,"form_stand_day5_2","form_stand_day5_2");

$form->addElement("text","form_cale_mon5_2","テキストフォーム","size=\"2\" maxLength=\"2\" ".$g_form_option."\"");
...
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","m","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day6_1[m]','form_stand_day6_1[d]',2)\" ".$g_form_option."\"");
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","d","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day6_1[d]','form_week_num6_1',2)\" ".$g_form_option."\"");
...
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","m","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day6_2[m]','form_stand_day6_2[d]',2)\" ".$g_form_option."\"");
$text[] =& $form->createElement("static","","","-");
$text[] =& $form->createElement("text","d","テキストフォーム","size=\"2\" maxLength=\"2\" onkeyup=\"changeText(this.form,'form_stand_day6_2[d]','form_week_num6_2',2)\" ".$g_form_option."\"");
...
//変更・一覧
$form->addElement("button","change_button","変更・一覧","onClick=\"javascript:Referer('1-1-116.php')\"");
//一括訂正(ヘッダー)
$form->addElement("button","all_button","一括訂正","style=\"color: #ff0000;\" onClick=\"location.href='$_SERVER[PHP_SELF]'\"");
...
//巡回日（ラジオボタン）(1)
$form_round_div = "";
$form_round_div[] =& $form->createElement("radio", "", "", "", "1");
$form_round_div[] =& $form->createElement("radio", "", "", "", "2");
$form_round_div[] =& $form->createElement("radio", "", "", "", "3");
$form_round_div[] =& $form->createElement("radio", "", "", "", "4");
$form_round_div[] =& $form->createElement("radio", "", "", "", "5");
$form_round_div[] =& $form->createElement("radio", "", "", "", "6");
$form_round_div[] =& $form->createElement("radio", "", "", "", "7");
$form_round_div[] =& $form->createElement("radio", "", "", "", "8");
$form->addGroup($form_round_div, "form_round_div_1", "form_round_div", "<br>");
//巡回日（ラジオボタン）(2)
$form_round_div = "";
$form_round_div[] =& $form->createElement("radio", "", "", "", "1");
$form_round_div[] =& $form->createElement("radio", "", "", "", "2");
...
$form_round_div[] =& $form->createElement("radio", "", "", "", "7");
$form_round_div[] =& $form->createElement("radio", "", "", "", "8");
$form->addGroup($form_round_div, "form_round_div_2", "form_round_div", "<br>");
