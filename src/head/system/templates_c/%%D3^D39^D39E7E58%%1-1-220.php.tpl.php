<?php /* Smarty version 2.6.14, created on 2010-05-12 21:30:49
         compiled from 1-1-220.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'Make_Sort_Link_Tpl', '1-1-220.php.tpl', 105, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['var']['display_num'] == 2): ?>
全<b><?php echo $this->_tpl_vars['var']['match_count']; ?>
</b>件
<?php else:  echo $this->_tpl_vars['var']['html_page']; ?>
...
?>
        <?php if ($this->_tpl_vars['page_data'][$this->_tpl_vars['j']][12] == 't'): ?>
        <tr class="Result5">
        ...
        <td align="right">
            ...
            <?php elseif ($_POST['form_display_num'] != 2 && $_POST['f_page1'] != ""): ?>
        ...
        <td><a href="1-1-221.php?goods_id=<?php echo $this->_tpl_vars['page_data'][$this->_tpl_vars['j']][1]; ?>
...
');">表示</a></td>
        ...
        <?php if ($this->_tpl_vars['page_data'][$this->_tpl_vars['j']][11] == '1'): ?>
        <td align="center">○</td>
        <?php else: ?>
...
<?php if ($this->_tpl_vars['var']['display_num'] != 2):  echo $this->_tpl_vars['var']['html_page2'];  endif; ?>
