<?php /* Smarty version 2.6.14, created on 2010-09-29 09:49:49
         compiled from 1-1-120.php.tpl */ ?>
...
<?php if ($_POST['form_staff_kind'] == 3 || $_POST['form_staff_kind'] == 4): ?>
...
"></td>
        <td bgcolor="#e0e0f0" class="top_left" colspan="2"><?php echo $this->_tpl_vars['ary_h_mod_data'][3][1][0][0]; ?>
</td>
    ...
    <tr>    
        <td bgcolor="#e0e0f0" class="left_bottom" rowspan="<?php echo $this->_tpl_vars['var']['h_submenu_rowspan'][3][0]; ?>
"></td>
        <td class="top_left"><?php echo $this->_tpl_vars['ary_h_mod_data'][3][1][0][1][0]; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['1']['r']['html']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['1']['w']['html']; ?>
</td>
    </tr>   
    <tr>    
        <td class="left"><?php echo $this->_tpl_vars['ary_h_mod_data'][3][1][0][1][1]; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['2']['r']['html']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['2']['w']['html']; ?>
</td>
    </tr>   
    <tr>    
        <td class="left"><?php echo $this->_tpl_vars['ary_h_mod_data'][3][1][0][1][2]; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['3']['r']['html']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['3']['w']['html']; ?>
</td>
    </tr>   
    <tr>    
        <td class="left"><?php echo $this->_tpl_vars['ary_h_mod_data'][3][1][0][1][3]; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['4']['r']['html']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['4']['w']['html']; ?>
</td>
    </tr>   
    <tr>    
        <td class="left_bottom"><?php echo $this->_tpl_vars['ary_h_mod_data'][3][1][0][1][4]; ?>
</td>
        <td class="bottom"><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['5']['r']['html']; ?>
</td>
        <td class="bottom"><?php echo $this->_tpl_vars['form']['permit']['h']['4']['1']['5']['w']['html']; ?>
</td>
    </tr> 
        <tr>
...
"></td>
    ...
    <tr>
        <td class="left_bottom"><?php echo $this->_tpl_vars['ary_h_mod_data'][5][1][2][1][10]; ?>
</td>
        <td class="bottom"><?php echo $this->_tpl_vars['form']['permit']['h']['6']['3']['11']['r']['html']; ?>
</td>
        <td class="bottom"><?php echo $this->_tpl_vars['form']['permit']['h']['6']['3']['11']['w']['html']; ?>
</td>
    </tr>
        <tr>
...
"></td>
    ...
    <tr>
        <td class="left_bottom"><?php echo $this->_tpl_vars['ary_h_mod_data'][5][1][3][1][3]; ?>
</td>
        <td class="bottom"><?php echo $this->_tpl_vars['form']['permit']['h']['6']['4']['4']['r']['html']; ?>
</td>
        <td class="bottom"><?php echo $this->_tpl_vars['form']['permit']['h']['6']['4']['4']['w']['html']; ?>
</td>
    </tr>
        <tr>
...
<?php endif; ?>
        ...
        <?php if ($_POST['form_staff_kind'] == 4): ?><td width="10"></td><?php endif; ?>
        <td valign="top">

<?php if ($_POST['form_staff_kind'] == 1 || $_POST['form_staff_kind'] == 2 || $_POST['form_staff_kind'] == 4): ?>
<table class="Data_Table" bgcolor="#ffffff">
<col width="17" style="font: bold 15px;">
<col width="17" style="font: bold;">
<col width="17" style="font: bold;">
