...
$form->addElement("submit", "preview_button", "¥×¥ì¥Ó¥å¡¼", "onClick=\"javascript:PDF_POST('".HEAD_DIR."system/1-1-309.php')\"");

// ¿·µ¬ÅÐÏ¿¥Ü¥¿¥ó
$form->addElement("submit", "form_new_button", "¿·µ¬ÅÐÏ¿", "onClick=\"javascript:Button_Submit('form_new_flg','#','true')\" $disabled");

// ÅÐÏ¿¥Ü¥¿¥ó
$form->addElement("submit", "new_button", "ÅÐ¡¡Ï¿", "onClick=\"javascript:return Dialogue('ÅÐÏ¿¤·¤Þ¤¹¡£','#')\" $disabled");

// ÊÑ¹¹¥Ü¥¿¥ó
$form->addElement("submit", "change_button", "ÊÑ¡¡¹¹", "onClick=\"javascript:Button_Submit('form_update_flg','#','true')\" $disabled");

// ¥¯¥ê¥¢¥Ü¥¿¥ó
$form->addElement("button", "clear_button", "¥¯¥ê¥¢", "onClick=\"location.href='$_SERVER[PHP_SELF]'\"");

// OK¥Ü¥¿¥ó
$form->addElement("button", "ok_button", "£Ï¡¡£Ë", "onClick=javascript:location.href='1-1-311.php' $disabled");
