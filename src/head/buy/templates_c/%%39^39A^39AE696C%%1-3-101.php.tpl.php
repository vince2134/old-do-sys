<?php /* Smarty version 2.6.14, created on 2010-05-12 19:57:57
         compiled from 1-3-101.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', '1-3-101.php.tpl', 118, false),)), $this); ?>
...
<br><a href="#" onClick="javascript:window.open('../stock/1-4-105.php?goods_id=<?php echo $this->_tpl_vars['item'][5]; ?>
');"><?php echo $this->_tpl_vars['item'][3]; ?>
</a></td>    
        <td align="right"><?php echo $this->_tpl_vars['item'][4]; ?>
</td>
        <td align="right"><a href="#" onClick="javascript:Open_mlessDialmg_g('1-3-111.php','<?php echo $this->_tpl_vars['item'][5]; ?>
',1,300,160);"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][6])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</a></td>
