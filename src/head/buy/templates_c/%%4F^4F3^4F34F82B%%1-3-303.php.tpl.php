<?php /* Smarty version 2.6.14, created on 2010-01-19 12:55:20
         compiled from 1-3-303.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'Make_Sort_Link_Tpl', '1-3-303.php.tpl', 69, false),array('modifier', 'number_format', '1-3-303.php.tpl', 114, false),)), $this); ?>
...
?>
    ...
    <?php endif; ?>
        ...
        <?php endif; ?>
                ...
                <td align="center"><a href="1-3-302.php?pay_id=<?php echo $this->_tpl_vars['item'][0]; ?>
...
<br><?php echo $this->_tpl_vars['item'][11]; ?>
                ...
                <?php if ($this->_tpl_vars['item'][13] < 0): ?><td align="right"><font color="#ff0000"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][13])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</font></td>
        <?php else: ?><td align="right"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][13])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</td><?php endif; ?>
                <?php if ($this->_tpl_vars['item'][14] < 0): ?><td align="right"><font color="#ff0000"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][14])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</font></td>
        <?php else: ?><td align="right"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][14])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</td><?php endif; ?>
                <?php if ($this->_tpl_vars['item'][15] < 0): ?><td align="right"><font color="#ff0000"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][15])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</font></td>
        <?php else: ?><td align="right"><?php echo ((is_array($_tmp=$this->_tpl_vars['item'][15])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</td><?php endif; ?>
                <td><?php echo $this->_tpl_vars['item'][20]; ?>
<br><?php echo $this->_tpl_vars['item'][21]; ?>
<br></td>
                <td><?php echo $this->_tpl_vars['item'][16]; ?>
</td>
                <?php if ($this->_tpl_vars['item'][17] == 't'): ?>
        <td align="center"><?php echo $this->_tpl_vars['item'][18]; ?>
</td>
        <td></td>
        <?php else: ?>
        <td align="center"></td>
                <td align="center"><?php if ($this->_tpl_vars['item'][18] == null && $this->_tpl_vars['item'][19] == null):  if ($this->_tpl_vars['var']['auth'] == 'w'): ?><a href="#" onClick="Order_Delete('data_delete_flg','pay_h_id','<?php echo $this->_tpl_vars['item'][0]; ?>
