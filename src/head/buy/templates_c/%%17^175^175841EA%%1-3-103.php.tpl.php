<?php /* Smarty version 2.6.14, created on 2009-12-21 16:31:48
         compiled from 1-3-103.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'regex_replace', '1-3-103.php.tpl', 205, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['var']['freeze_flg'] == true): ?>
    ...
    <span style="color: #ff0000; font-weight: bold; line-height: 130%;">
     <li>仕入が完了しているため、変更できません。<br>
    </span> 
    <?php endif; ?>
	<table width="100%" align="center">
        <?php if ($_GET['output_flg'] != 'finish' && $_GET['output_flg'] != 'delete'): ?>
	    <tr>
            <td align="center">
	        <span style="font: bold 16px;">発注完了しました。</span><br><br>
            </td>
        </tr>
        <?php endif; ?>
        <tr>
