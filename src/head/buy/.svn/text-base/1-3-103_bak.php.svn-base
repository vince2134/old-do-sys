...
/****************************/
//(¥¯¥¨¥ê¡¼·ë²Ì¡¦¶¯À©´°Î»¥Õ¥é¥°¡¦½èÍý¾õ¶·)
function Get_Ord_Data($result,$finish_flg,$ord_stat){
...
$online_flg   = $_GET["online_flg"];         //È¯ÃíÆþÎÏ¥ª¥ó¥é¥¤¥ó¼±ÊÌ¥Õ¥é¥°
$offline_flg  = $_GET["offline_flg"];        //È¯ÃíÆþÎÏ¥ª¥Õ¥é¥¤¥ó¼±ÊÌ¥Õ¥é¥°
...
//Á«°Ü¸µ¥Á¥§¥Ã¥¯
if($online_flg == true){
	//È¯ÃíÆþÎÏ¡Ê¥ª¥ó¥é¥¤¥ó¡Ë²èÌÌ
	//OK¥Ü¥¿¥ó
	$form->addElement("button","ok_button","£Ï¡¡£Ë","onClick=\"location.href='2-3-102.php'\"");
	$warning = "ÊÑ¹¹¤¹¤ëºÝ¤Ë¤Ï¡¢ËÜÉô¤Ë¼è¾Ã¤ò°ÍÍê¤·¤Æ²¼¤µ¤¤¡£";
	$freeze_flg = true;    //È¯Ãí´°Î»¥á¥Ã¥»¡¼¥¸É½¼¨¥Õ¥é¥°
}else if($offline_flg == true){
	//È¯ÃíÆþÎÏ¡Ê¥ª¥Õ¥é¥¤¥ó¡Ë²èÌÌ
	//OK¥Ü¥¿¥ó
	$form->addElement("button","ok_button","£Ï¡¡£Ë","onClick=\"location.href='2-3-102.php'\"");
	//Ìá¤ë
	$form->addElement("button","return_button","Ìá¡¡¤ë","onClick=\"location.href='2-3-102.php?ord_id=$ord_id'\"");
	$freeze_flg = true;    //È¯Ãí´°Î»¥á¥Ã¥»¡¼¥¸É½¼¨¥Õ¥é¥°
}else{
	//È¯Ãí¾È²ñ²èÌÌ
	if($ord_flg == true){
		//Ìá¤ë
		$form->addElement("button","return_button","Ìá¡¡¤ë","onClick=\"location.href='2-3-104.php'\"");
	}else{
		//Ìá¤ë
...
$def_fdata["form_note_my"]                      =   $h_data_list[0][12];                     //ÄÌ¿®Íó(»ÅÆþÀè)
