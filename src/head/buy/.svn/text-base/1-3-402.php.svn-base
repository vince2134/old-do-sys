...
$list[1] = array("240","仕入先","C");
$list[2] = array("105","前月未残","C");
$list[3] = array("105","当月支払","C");
$list[4] = array("105","調整額","C");
$list[5] = array("105","繰越額","C");
$list[6] = array("105","当月仕入","C");
$list[7] = array("105","消費税","C");
$list[8] = array("105","税込仕入","C");
$list[9] = array("105","今回残高","C");

//合計名
$list_sub[0] = array("240","合計","L");
...
//データ取得SQL
$sql = "select supplier_name,last_money,pay_money,adjust_money,transfer_money,lay_in,tax,tax_stock,balance from t_payable;";

//現在の日付取得SQL
$sql_sale = "SELECT DISTINCT date FROM t_payable;";
...
//************************データ表示***************************
	...
	$pdf->Cell($list[$x][0], 14, $data_list[$x-1], '0', '2', $data_align[$x]);
}
//*************************************************************
