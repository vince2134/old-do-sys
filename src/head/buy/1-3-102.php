...
$form->addElement(
    ...
    onChange=\"javascript:Button_Submit('hdn_designated_date_flg','#','t', this)\""
);
...
*/
    ...
    //行追加ボタン
    if($client_search_flg === true){
        $form->addElement("button","form_add_row_button", "追　加", "onClick=\"javascript:Button_Submit('add_row_flg','#foot','true', this)\"");
    }
