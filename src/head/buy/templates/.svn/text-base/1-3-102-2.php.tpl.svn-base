...
<table>
    <tr>
        <td>
            <span style="font: bold 15px;">下記の内容で発注してもよろしいですか？</span><br><br>
            {$form.button.touroku2.html}　　{$form.button.after_touroku.html}　　{$form.button.modoru.html}
        </td>
    </tr>
</table>
<br>
