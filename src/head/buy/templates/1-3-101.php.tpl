...
<table class="List_Table" border="1" width="100%">
    ...
    <tr class="{$tr[$i]}">
        ...
        <td>{$item[0]}</td>
        <td>{$item[1]}</td>
        <td>{$item[2]}<br><a href="#" onClick="javascript:window.open('../stock/1-4-105.php?goods_id={$item[5]}');">{$item[3]}</a></td>    
        <td align="right">{$item[4]}</td>
        <td align="right"><a href="#" onClick="javascript:Open_mlessDialmg_g('1-3-111.php','{$item[5]}',1,300,160);">{$item[6]|number_format}</a></td>
