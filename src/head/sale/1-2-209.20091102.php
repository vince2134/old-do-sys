...
/****************************/
//¥³¥á¥ó¥È­¡
$freeze = $form->addElement("text","d_memo1".$x,"¥Æ¥­¥¹¥È¥Õ¥©¡¼¥à","size=\"50\" maxLength=\"46\" style=\"font-size:12px;\"".$g_form_option."\"");
$freeze->freeze();
//¥³¥á¥ó¥È­¢
$freeze = $form->addElement("text","d_memo2".$x,"¥Æ¥­¥¹¥È¥Õ¥©¡¼¥à","size=\"50\" maxLength=\"46\" style=\"font-size:12px;\"".$g_form_option."\"");
$freeze->freeze();
...
//Ç¼ÉÊ½ñ½ÐÎÏ¥Ü¥¿¥ó
$form->addElement("button","deli_button","¥×¥ì¥Ó¥å¡¼","onClick=\"javascript:window.open('../system/1-1-317.php','_blank','')\"");
