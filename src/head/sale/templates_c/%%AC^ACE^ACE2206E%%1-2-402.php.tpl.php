<?php /* Smarty version 2.6.14, created on 2010-01-08 15:28:31
         compiled from 1-2-402.php.tpl */ ?>
...
<br></td>
    ...
    <tr>
        ...
        <td class="Value" colspan="3"><?php echo $this->_tpl_vars['form']['form_payin_date']['html']; ?>
</td>
    </tr>
    <tr>
        <td class="Title_Pink" valign="bottom">請求先<span style="color: #ff0000;">※</span><br><br style="font-size: 8px;">振込名義1<br>振込名義2<br></td>
...
<br><br style="font-size: 5px;"><div id="pay_account_name"><?php echo $this->_tpl_vars['var']['pay_account_name']; ?>
        ...
        <td class="Value"><div id="bill_no_amount"><?php echo $this->_tpl_vars['var']['bill_no_amount']; ?>
</div></td>
    </tr>
</table>
