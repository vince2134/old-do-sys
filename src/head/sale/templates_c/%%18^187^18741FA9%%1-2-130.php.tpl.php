<?php /* Smarty version 2.6.14, created on 2010-05-12 19:28:39
         compiled from 1-2-130.php.tpl */ ?>
...
<table class="List_Table" border="1" width="650">
    ...
    <tr>
        <td class="Value" align="right"><?php echo $this->_tpl_vars['var']['total_shop']; ?>
</td>
        <td class="Value" align="right"><?php echo $this->_tpl_vars['var']['total_num']; ?>
</td>
        <td class="Value" align="right"><?php echo $this->_tpl_vars['var']['total_rental']; ?>
</td>
        <td class="Value" align="right"><?php echo $this->_tpl_vars['var']['total_user']; ?>
</td>
    </tr>
</table>
<br><hr><br>
