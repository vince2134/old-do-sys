<?php /* Smarty version 2.6.14, created on 2010-01-08 15:58:27
         compiled from 1-2-403.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'Make_Sort_Link_Tpl', '1-2-403.php.tpl', 63, false),array('modifier', 'number_format', '1-2-403.php.tpl', 105, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['var']['post_flg'] == true && $this->_tpl_vars['err_flg'] != true): ?>
...
" align="right"><?php echo $this->_tpl_vars['item'][1]; ?>
        ...
        <?php if ($this->_tpl_vars['item'][0] != 0): ?><td rowspan="<?php echo $this->_tpl_vars['item'][0]; ?>
" align="center"><a href="./1-2-402.php?payin_id=<?php echo $this->_tpl_vars['item'][2]; ?>
