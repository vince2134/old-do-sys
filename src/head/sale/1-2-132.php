...
$form_staff_id = Select_Get($db_con,'cstaff');
	...
	"onKeyDown=\"chgKeycode();\" onChange =\"Button_Submit('client_search_flg','#','true', this);window.focus();\"");
...
if($online_flg == 'f'){
	//自動入力
	$form->addElement("button","input_auto", "自動入力", "onClick=\"javascript:Button_Submit_1('auto_flg', '#', 'true', this)\"");
	//行追加ボタン
	$form->addElement("button","add_row_btn","行追加","onClick=\"javascript:Button_Submit('add_row_flg', '#foot', 'true', this)\"");
	//入力欄を表示
	$form->addElement("button","input_form_btn", "入力欄を表示", "onClick=\"javascript:Button_Submit_1('input_form_flg', '#', 'true', this)\"");
...
if($disp_stat == 6 && $online_flg == 't'){
	...
	$form->addElement("button","cancel_ok_btn", "申請取消OK", "onClick=\"javascript:Button_Submit_1('cancel_flg', '#','true', this)\"");//申請取消ＯＫボタン
/*
//契約済・解約済(オフライン)
...
//解約申請(本部)
	...
	$form->addElement("button","cancel_ok_btn", "解約取消OK", "onClick=\"javascript:Button_Submit_1('cancel_flg', '#','true', this)\""); //解約取消ＯＫボタン
...
//解約予定(本部)
	...
	$form->addElement("button","input_auto", "自動入力", "onClick=\"javascript:Button_Submit_1('auto_flg', '#', 'true', this)\"");//自動入力
