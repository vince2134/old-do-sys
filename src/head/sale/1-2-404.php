...
// 請求先
$text36_1[] =& $form->createElement("text", "code1", "", "size=\"7\" maxLength=\"6\" value=\"\" style=\"$g_form_style\" onKeyUp=\"javascript:display(this,'claim')\" $g_form_option");
$text36_1[] =& $form->createElement("static","","","-");
$text36_1[] =& $form->createElement("text", "code2", "","size=\"4\" maxLength=\"4\" value=\"\" style=\"$g_form_style\" onKeyUp=\"javascript:display(this,'claim')\" $g_form_option");
$form->addGroup( $text36_1, "f_claim1", "f_claim1");

$form->addElement("text", "t_claim1", "", "size=\"34\" value=\"\" style=\"color : #000000; border : #ffffff 1px solid; background-color: #ffffff;\" readonly");

// 入金額
$form->addElement("text", "f_text9", "", "size=\"11\" maxLength=\"9\" value=\"\" $g_form_option style=\"text-align: right; $g_form_style\"");
...
// 変更ボタン
$form->addElement("button", "f_change1", "変　更", "onClick=\"javascript:Dialogue('変更します。','".HEAD_DIR."sale/1-2-403.php', this)\"");
