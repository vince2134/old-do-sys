...
if($verify_flg != true && $verify_only_flg != true){
    ...
    // 行追加ボタン
    $form->addElement("button", "form_add_row_btn", "行追加", "onClick=\"javascript:Button_Submit_1('add_row_flg', '#foot', 'true', this)\"");

    // 合計ボタン
    $form->addElement("button", "form_calc_btn", "合　計", "onClick=\"javascript:Button_Submit('calc_flg','#foot','true', this)\"");
