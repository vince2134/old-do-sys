...
{*+++++++++++++++ 画面表示１ begin +++++++++++++++*}
<input type="button" value="得意先単位" onclick="javascript:location='1-2-402.php'">
<input type="button" value="銀行単位" style="color: #ff0000;" onclick="javascript:location='1-2-402_2.php'">
<br><br><br>
