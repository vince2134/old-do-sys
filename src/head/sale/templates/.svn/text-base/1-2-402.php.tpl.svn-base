...
<col>
    ...
    <tr>
        <td class="Title_Pink" valign="bottom">
            {if $var.verify_flg != true && $var.verify_only_flg != true}<a href="#" onClick="return Open_SubWin('../dialog/1-0-402.php',Array('form_client[cd1]','form_client[cd2]','form_client[name]','client_search_flg'),500,450,5,1);">得意先</a>{else}得意先{/if}<font color="#ff0000">※</font><br><br style="font-size: 8px;">銀行<br>支店<br>口座</td>
