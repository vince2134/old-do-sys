...
<table class="List_Table" border="1" align="right" width="100%">
    <tr>
        ...
        <td class="Value" align="right" width="120">{$form.form_sale_total.html}</td>
        <td class="Title_Blue" width="80" align="center"><b>消費税</b></td>
        <td class="Value" align="right" width="120">{$form.form_sale_tax.html}</td>
        <td class="Title_Blue" width="80" align="center"><b>税込金額</b></td>
        <td class="Value" align="right" width="120">{$form.form_sale_money.html}</td>
    </tr>
</table>
        ...
        <td>
            <table class="List_Table" border="1" width="500" align="left">
                <tr>
                    ...
                    <td class="Value" width="100">{$form.form_division_num.html}</td>
                </tr>
            </table>
        </td>
        <td>
