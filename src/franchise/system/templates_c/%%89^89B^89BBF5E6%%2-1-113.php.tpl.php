<?php /* Smarty version 2.6.14, created on 2010-01-12 15:55:03
         compiled from 2-1-113.php.tpl */ ?>
...
<?php if ($this->_tpl_vars['var']['qf_err_flg'] == true): ?>
    ...
    <?php if ($this->_tpl_vars['form']['form_gr_cd']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_gr_cd']['error']; ?>
<br><?php endif; ?>
    <?php if ($this->_tpl_vars['form']['form_gr_name']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_gr_name']['error']; ?>
<br><?php endif; ?>
    <?php if ($this->_tpl_vars['var']['space_err'] != null): ?><li><?php echo $this->_tpl_vars['var']['space_err']; ?>
<br><?php endif; ?>
    </span><br>
<?php endif; ?>
...
<col>
    <tr>
        <td class="Title_Purple"><?php echo $this->_tpl_vars['form']['form_gr_cd']['label']; ?>
<font color="#ff0000">※</font></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['form_gr_cd']['html']; ?>
</td>
    </tr>
    <tr>
        <td class="Title_Purple"><?php echo $this->_tpl_vars['form']['form_gr_name']['label']; ?>
<font color="#ff0000">※</font></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['form_gr_name']['html']; ?>
</td>
    </tr>
    <tr>
