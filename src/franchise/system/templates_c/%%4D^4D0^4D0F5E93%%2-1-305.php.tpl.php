<?php /* Smarty version 2.6.14, created on 2010-09-15 17:48:54
         compiled from 2-1-305.php.tpl */ ?>
...
?>
    <?php if ($this->_tpl_vars['show_data'][$this->_tpl_vars['i']][8] == 't'): ?>
    <tr class="Result1" style="font-weight: bold; color: blue;">
    <?php elseif ($this->_tpl_vars['show_data'][$this->_tpl_vars['i']][8] == 'f'): ?>
