<?php /* Smarty version 2.6.14, created on 2010-01-20 13:40:20
         compiled from 2-1-108.php.tpl */ ?>
...
<?php if ($this->_tpl_vars['form']['form_staff_cd']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_staff_cd']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_charge_cd']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_charge_cd']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_staff_name']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_staff_name']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_staff_ascii']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_staff_ascii']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_login_id']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_login_id']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_password1']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_password1']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_birth_day']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_birth_day']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_join_day']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_join_day']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_retire_day']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_retire_day']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_photo_ref']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_photo_ref']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_license']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_license']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_note']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_note']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['permit_error']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['permit_error']['error']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['var']['staff_del_restrict_msg'] != null): ?><li><?php echo $this->_tpl_vars['var']['staff_del_restrict_msg']; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['form']['form_part']['error'] != null): ?><li><?php echo $this->_tpl_vars['form']['form_part']['error']; ?>
<br><?php endif; ?>
</span>
...
<span style="font-size: 15px; color: #555555; font-weight: bold;"><?php echo $this->_tpl_vars['form']['form_h_change_flg']['html']; ?>
</span>
...
<col width="200">
    ...
    <tr>
        ...
        <td class="Value" rowspan="8">
            <table width="120" height="140" align="center" style="background-image: url(2-1-110.php?staff_id=<?php echo $this->_tpl_vars['var']['staff_id']; ?>
...
<col>
    ...
    <tr>
        <td class="Title_Purple"><?php echo $this->_tpl_vars['form']['form_permit_link']['html']; ?>
</td>
...
<table width="100%">
    <tr>
        <td><?php if ($this->_tpl_vars['var']['change_flg'] == 'f'):  echo $this->_tpl_vars['form']['del_button']['html'];  endif; ?><td>
