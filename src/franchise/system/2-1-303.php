 ...
 *  日付            B票No.      担当者      内容
 *  -----------------------------------------------------------
 *  2015/05/019         amano  Dialogue関数でボタン名が送られない IE11 バグ対応
 *
*/
...
//コメント7〜12
for($x=7;$x<=12;$x++){
//	$form->addElement("text","o_memo".$x,"テキストフォーム","size=\"130\" maxLength=\"92\" style=\"font-size:15px;\"".$g_form_option."\"");
...
//発注書発行ボタン
//$form->addElement("button","order_button","発注書発行","onClick=\"javascript:window.open('".FC_DIR."buy/2-3-107.php','_blank','')\"");
$form->addElement("button","order_button","プレビュー","onClick=\"javascript:window.open('".FC_DIR."buy/2-3-107.php','_blank','')\"");
