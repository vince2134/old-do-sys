...
{/if}
{*--------------------- 画面表示1開始 --------------------*}
<font size="+0.5" color="#555555"><b>【巡回担当者一括訂正】</b></font>
<table class="List_Table" border="1">
    ...
    <tr>
        <td class="Title_Purple"><b>担当者</b></td>
        <td class="Value" colspan="3">{$form.f_select1.html}</td>
    </tr>
</table>
...
<table class="List_Table" border="1" width="100%">
    <tr align="center">
        ...
        <td class="Title_Purple"><b>サービス</b></td>
    ...
    {/if}   
        ...
        <td align="right">{$demo_data[$i][6]}</td>
        <td align="left"><font color="blue"><b>{$demo_data[$i][7]}</b></font></td>
