...
if ($_GET["bank_id"] != null && Get_Id_Check_Db($db_con, $_GET["bank_id"], "bank_id", "t_bank", "num", $where) != true){
...
$form->addElement("button","bank_account_button","口座登録画面","onClick=\"javascript:Referer('2-1-210.php')\"");
...
//◇銀行名（フリガナ）
//・必須チェック
$form->addRule('form_bank_kana','銀行名 は1文字以上15文字以下です。','required');

//◇略称
//・必須チェック
$form->addRule('form_bank_cname','略称 は1文字以上10文字以下です。','required');
$form->addRule("form_bank_cname", "略称 にスペースのみの登録はできません。", "no_sp_name");
