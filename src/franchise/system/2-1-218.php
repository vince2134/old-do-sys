...
//一括訂正
$form->addElement("button","new_button","登録画面","onClick=\"javascript:Referer('2-1-219.php')\"");
...
if($_POST["show_button"]=="表　示"){
    ...
    if($output_type == 1){
        ...
        $sql .= "t_client.client_cd1,";      //請求先コード１
        $sql .= "t_client.client_cd2,";      //請求先コード２
        $sql .= "t_client.client_name ";     //請求先
        $sql .= "FROM ";
        $sql .= "t_direct ";
        $sql .= "LEFT JOIN ";
        ...
        while($data_list = pg_fetch_array($result)){
            ...
            //住所
            $direct_data[$i][5] = $data_list[6];
            $direct_data[$i][6] = $data_list[7];
            $direct_data[$i][7] = $data_list[8];
            //TEL
