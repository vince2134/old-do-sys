...
/****************************/
//社印画像表示スクリプトパス
$path_shain = FC_DIR."system/2-1-301-3.php?shop_id=".$shop_id;

//元画面（自社プロフィール画面）
$page_name = "2-1-301.php";
...
$form->addElement("submit","form_entry","登　録","onClick=\"javascript:return dialogue5('社印を登録します。');\" $disabled");
