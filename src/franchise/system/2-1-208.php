 ...
 *  日付            B票No.      担当者      内容
 *  -----------------------------------------------------------
 *  2006-12-08      ban_0081    suzuki      登録・変更のログを残すように修正
 *  2007-05-07                  kaku-m      csv出力項目の追加
...
/* GETしたIDの正当性チェック */
$where  = " bank_id IN (SELECT bank_id FROM t_bank WHERE shop_id ";
$where .= ($_SESSION["client_id"] == "2") ? " IN (".Rank_Sql().") " : " = ".$_SESSION["client_id"]." ";
$where .= ") ";
