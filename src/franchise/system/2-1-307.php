...
// 取引銀行
for($x=5;$x<=12;$x++){
//    $commit_freeze[] = $form->addElement("text", "c_memo".$x,"", "size=\"68\" maxLength=\"62\" style=\"font-size: 10px;\" $g_form_option");
...
// 請求書発行ボタン
$form->addElement("submit", "preview_button", "プレビュー", "onClick=\"javascript:PDF_POST('2-1-307-2.php')\"");
...
// OKボタン
$form->addElement("button", "ok_button", "Ｏ　Ｋ", "onClick=javascript:location.href='2-1-307.php' $disabled");
