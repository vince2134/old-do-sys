...
if($complete_flg == true){
    ...
    if($change_flg === true){
        ...
        $button[] = $form->createElement("submit", "entry_button", "登　録", "onClick=\"javascript:return Dialogue('$message', '#')\" $disabled");
    }else{
        $button[] = $form->createElement("submit", "entry_button", "登　録", "onClick=\"javascript:return Dialogue('登録します。', '#')\" $disabled");
    }
