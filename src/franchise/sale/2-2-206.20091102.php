...
if ($post_flg == true){
    ...
    $html_2 .= "        <td>".number_format($kake_notax)."</td>\n";
    $html_2 .= "        <td class=\"Title_Pink\">掛売消費税</td>\n";
    $html_2 .= "        <td>".number_format($kake_tax)."</td>\n";
    $html_2 .= "        <td class=\"Title_Pink\">掛売合計</td>\n";
    $html_2 .= "        <td>".number_format($kake_ontax)."</td>\n";
    $html_2 .= "    </tr>\n";
    $html_2 .= "    <tr class=\"Result1\">\n";
    $html_2 .= "        <td class=\"Title_Pink\">現金金額</td>\n";
    $html_2 .= "        <td>".number_format($genkin_notax)."</td>\n";
    $html_2 .= "        <td class=\"Title_Pink\">現金消費税</td>\n";
    $html_2 .= "        <td>".number_format($genkin_tax)."</td>\n";
    $html_2 .= "        <td class=\"Title_Pink\">現金合計</td>\n";
    $html_2 .= "        <td>".number_format($genkin_ontax)."</td>\n";
    $html_2 .= "    </tr>\n";
    $html_2 .= "    <tr class=\"Result1\">\n";
    $html_2 .= "        <td class=\"Title_Pink\">税抜合計</td>\n";
    $html_2 .= "        <td>".number_format($notax_amount)."</td>\n";
    $html_2 .= "        <td class=\"Title_Pink\">消費税合計</td>\n";
    $html_2 .= "        <td>".number_format($tax_amount)."</td>\n";
    $html_2 .= "        <td class=\"Title_Pink\">税込合計</td>\n";
    $html_2 .= "        <td>".number_format($ontax_amount)."</td>\n";
    $html_2 .= "    </tr>\n";
    $html_2 .= "</table>\n";
    $html_2 .= "\n";
