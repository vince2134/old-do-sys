<?php /* Smarty version 2.6.14, created on 2009-12-06 13:03:51
         compiled from 2-2-118.php.tpl */ ?>
...
　<?php echo $this->_tpl_vars['form']['slip_copy_button']['html']; ?>
　　　　　　<?php echo $this->_tpl_vars['form']['return_edit_button']['html']; ?>
</td>
        </tr>
    </table>
<?php else: ?>
...
<table class="List_Table" border="1">
    <tr align="center">
        ...
        <td class="Title_Pink" nowrap><b>
                ...
                <?php if ($this->_tpl_vars['var']['comp_flg'] == null && $this->_tpl_vars['var']['renew_flg'] != 'true'): ?>
...
％<br>
    ...
    <tr class="Result1">
        ...
        <td class="Value" width="185" colspan="6"><?php echo $this->_tpl_vars['form']['form_direct_select']['html']; ?>
</td>
    </tr>
...
％</td><td></td></tr>
    ...
    <tr>
        ...
        <td class="Value" colspan="3"><?php echo $this->_tpl_vars['form']['form_daiko']['cd1']['html']; ?>
...
％</td><td></td></tr>
    ...
    <tr class="Result1">
        ...
        <td class="Value" colspan="6"><?php echo $this->_tpl_vars['form']['form_note']['html']; ?>
</td>
        <?php else: ?>
...
<br><?php echo $this->_tpl_vars['form']['form_sale_tax']['html']; ?>
    ...
    <tr class="Result1">
        ...
        <td class="Value" colspan="3" align="right"><?php echo $this->_tpl_vars['form']['form_ad_rest_price']['html']; ?>
</td>
    ...
    <?php if ($this->_tpl_vars['var']['warning'] == null && $this->_tpl_vars['var']['comp_flg'] == null && $this->_tpl_vars['var']['renew_flg'] != 'true'): ?>
        <?php echo $this->_tpl_vars['form']['form_sum_btn']['html']; ?>
...
<table border="0" width="985">
    <tr>
        <td align="left"><font size="+0.5" color="#555555"><b>【商品出荷倉庫：<?php if ($this->_tpl_vars['var']['comp_flg'] == null): ?><span id="ware_name"><?php else:  echo $_POST['hdn_ware_name'];  endif; ?></span>&nbsp;】</b></font></td>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <?php if ($this->_tpl_vars['var']['renew_flg'] == 'true'): ?>
					...
					<?php if ($this->_tpl_vars['var']['warn_lump_change'] == null):  echo $this->_tpl_vars['form']['form_sale_btn']['html'];  endif; ?>
					<?php if ($this->_tpl_vars['var']['new_entry'] == 'false'): ?>　<?php echo $this->_tpl_vars['form']['form_back_button']['html'];  endif; ?>
				</td>
