<?php /* Smarty version 2.6.14, created on 2010-07-29 11:46:52
         compiled from 2-2-214.php.tpl */ ?>
...
?>
    ...
    <?php endif;  endforeach; endif; unset($_from);  if ($this->_tpl_vars['form']['form_trade_sale']['error'] != null): ?>
    <li><?php echo $this->_tpl_vars['form']['form_trade_sale']['error']; ?>
<br>
<?php endif;  if ($this->_tpl_vars['form']['form_claim_day']['error'] != null): ?>
    <li><?php echo $this->_tpl_vars['form']['form_claim_day']['error']; ?>
<br>
<?php endif;  if ($this->_tpl_vars['var']['client_msg'] != null): ?>
    <li><?php echo $this->_tpl_vars['var']['client_msg']; ?>
<br>
<?php endif;  if ($this->_tpl_vars['var']['renew_msg'] != null): ?>
