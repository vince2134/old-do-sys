<?php /* Smarty version 2.6.14, created on 2009-12-29 10:59:35
         compiled from 2-2-304.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', '2-2-304.php.tpl', 103, false),array('modifier', 'escape', '2-2-304.php.tpl', 149, false),array('modifier', 'date_format', '2-2-304.php.tpl', 180, false),)), $this); ?>
...
<table width="100%">
    ...
    <tr>
        <?php if ($this->_tpl_vars['claim_data']['advance_balance'] != 0): ?>
        <td align="left">
        <table class="List_Table" border="1" width="">
            <tr class="Result1">
                <td class="Title_Pink" width="" ><b><?php echo @ADBANCE_BALANCE; ?>
</b></td>
                <td width="100" align="right"><?php echo ((is_array($_tmp=$this->_tpl_vars['claim_data']['advance_balance'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
</td>
            </tr>
        </table>
        </td>
...
?>
    ...
    <tr class="Result1">
        ...
        <?php if ($this->_tpl_vars['bill_d_data'][$this->_tpl_vars['i']][$this->_tpl_vars['j']]['position'] == 2): ?>
        <td align="right"><?php echo $this->_tpl_vars['split_bill_data'][$this->_tpl_vars['i']][$this->_tpl_vars['j']]['formal_name']; ?>
</td>
        <?php else: ?>
        <td align="left"><?php echo $this->_tpl_vars['split_bill_data'][$this->_tpl_vars['i']][$this->_tpl_vars['j']]['formal_name']; ?>
</td>
        <?php endif; ?>
        ...
        <td align="right"><?php echo $this->_tpl_vars['split_bill_data'][$this->_tpl_vars['i']][$this->_tpl_vars['j']]['pay_amount']; ?>
</td>
        <td align="center"></td>
    </tr>
    <?php endif; ?>
...
<table width="100%">
    <tr>
        ...
        <?php if ($this->_tpl_vars['claim_data']['bill_format'] != '3'): ?>
