 ...
 * 　2006/10/26　04-006　　　yamanaka-s　　回収予定額がマイナスの場合は「0」と表示するようにSQLを修正
 *   2006/12/07  bun_0067　　suzuki　　　　日付をゼロ埋め
 *   2007/03/23              watanabe-k    表示ボタンをクリックせずにページ遷移するとエラーがでるのを修正
 */
