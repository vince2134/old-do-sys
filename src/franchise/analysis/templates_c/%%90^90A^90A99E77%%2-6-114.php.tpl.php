<?php /* Smarty version 2.6.14, created on 2010-04-20 15:08:04
         compiled from 2-6-114.php.tpl */ ?>
...
<table class="Data_Table" border="1" width="650" >
    ...
    <tr>
        <td class="Title_Gray" width="100"><b>Ω–Œœ∑¡º∞</b></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['f_r_output2']['html']; ?>
</td>
        <td class="Title_Gray" width="100"><b>Ω–Œœ∂‚≥€</b></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['f_radio13']['html']; ?>
</td>
    </tr>

    <tr>
        <td class="Title_Gray"width="100"><b>ºË∞˙«Ø∑Ó</b></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['f_date_d1']['html']; ?>
</td>
        <td class="Title_Gray" width="100"><b>Ω–Œœ∆‚Õ∆</b></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['f_radio67']['html']; ?>
</td>
    </tr>
    <tr>
        <td class="Title_Gray"width="110"><b>√¥≈ˆº‘Ãæ</b></td>
        <td class="Value" colspan="3"><?php echo $this->_tpl_vars['form']['f_select21']['html']; ?>
</td>
    </tr>

    <tr>
        <td class="Title_Gray" width="100"><b>£Õ∂Ë ¨</b></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['form_g_goods_1']['html']; ?>
</td>
        <td class="Title_Gray" width="100"><b>¿Ω… ∂Ë ¨</b></td>
        <td class="Value"><?php echo $this->_tpl_vars['form']['form_product_1']['html']; ?>
</td>
    </tr>

    <tr>
        <td class="Title_Gray" width="100"><b>¬–æ›µÚ≈¿</b></td>
...
<font size="+0.5" color="#555555"><b>°⁄ºË∞˙«Ø∑Ó°ß2005-01 °¡ 2005-12°°µÚ≈¿1°€</b></font>
<table class="List_Table" border="1" width="100%">
    <tr align="center">
        <td class="Title_Gray"><b>No.</b></td>
        <td class="Title_Gray" width=""><b>√¥≈ˆº‘Ãæ</b></td>
        <td class="Title_Gray" width=""><b>æ¶… Ãæ</b></td>
        <td class="Title_Gray" width=""><b>«‰æÂ∂‚≥€</b></td>
        <td class="Title_Gray" width=""><b>πΩ¿Æ»Ê</b></td>
        <td class="Title_Gray" width=""><b>Œﬂ¿—∂‚≥€</b></td>
        <td class="Title_Gray" width=""><b>Œﬂ¿—πΩ¿Æ»Ê</b></td>
        <td class="Title_Gray" width=""><b>∂Ë ¨</b></td>
    </tr>

    <tr class="Result1">
        <td align="right" rowspan="9">1</td>
        <td align="left" rowspan="9">√¥≈ˆº‘A</td>
        <td align="left">æ¶… 5</td>
    ...
    <tr class="Result1">
        <td align="right" rowspan="9">2</td>
        <td align="left" rowspan="9">√¥≈ˆº‘B</td>
        <td align="left">æ¶… 5</td>
        <td align="right">3,500</td>
        <td align="right">34.70%</td></td>
        <td align="right">3,500</td>
    ...
    <tr class="Result4">
        <td align="left"><b>πÁ∑◊</b></td>
        <td align="left"><b>2øÕ</b></td>
        <td align="left"></td>
        <td align="right"><b>20,180</b></td>
        <td align="center"><b>-</b></td></td>
        <td align="center"><b>-</b></td>
        <td align="center"><b>-</b></td>
        <td align="center"></td>
