...
// 出力金額
$radio29[] =& $form->createElement("radio", null, null, "売上金額", "1");
$radio29[] =& $form->createElement("radio", null, null, "粗利益額", "2");
...
// 担当者名
$select_man = array("","担当者A", "担当者B", "担当者C", "担当者D");
$form->addElement("select", "f_select21", "", $select_man, $g_form_option_select);
