<?php /* Smarty version 2.6.14, created on 2010-01-16 14:57:00
         compiled from 2-3-301.php.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'number_format', '2-3-301.php.tpl', 176, false),)), $this); ?>
...
<col>
    ...
    <tr>
        <td class="Td_Search_1">仕入先</td>
        <td class="Td_Search_1" colspan="3"><?php echo $this->_tpl_vars['form']['form_client']['html']; ?>
...
?>
    ...
    <?php endif; ?>
        ...
        <td align="center"><?php echo $this->_tpl_vars['row'][$this->_tpl_vars['j']][14]; ?>
</td>
	<?php if ($this->_tpl_vars['row'][$this->_tpl_vars['j']][13] == '2'): ?>
	        <td align="left"><?php echo $this->_tpl_vars['row'][$this->_tpl_vars['j']][0]; ?>
...
<br>
        ...
        <td align="center"><a href='2-3-308.php?pay_id=<?php echo $this->_tpl_vars['row'][$this->_tpl_vars['j']][11]; ?>
&c_id=<?php echo $this->_tpl_vars['row'][$this->_tpl_vars['j']][15]; ?>
