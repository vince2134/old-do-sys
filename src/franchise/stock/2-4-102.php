...
$list[1] = array("190","Ｍ区分","C");
$list[2] = array("340","商品名","C");
$list[3] = array("153","倉庫","C");
$list[4] = array("129","在庫数","C");
$list[5] = array("129","在庫単価","C");
$list[6] = array("129","在庫金額","C");

//Ｍ区分計・合計名
$list_sub[0] = array("190","Ｍ区分計","L");
$list_sub[1] = array("190","合計","L");
...
//データ取得SQL(Ｍ区分,商品名,倉庫,在庫数,在庫単価,在庫金額)
