...
//$form->addElement(
//    "submit", "form_adjust_button", "実　施",
//     "id=\"form_adjust_button\" onClick=\"javascript:return Dialogue('在庫を調整します。','#', this)\" $disabled");
$form->addElement(
    "submit", "form_adjust_button", "実　施",
     "id=\"form_adjust_button\" onClick=\"javascript:return Dialogue('在庫を調整します。','#')\" $disabled");
