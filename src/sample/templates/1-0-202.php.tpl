...
<table  class="Data_Table" border="1" width="650" >
	...
	<tr>
		...
		<td class="Value">{$form.f_text10.html}</td>
	</tr>
...
<table width='650'>
	<tr>
		<td align='right'>
			{$form.button.hyouji.html}　　{$form.button.kuria.html}
		</td>
	</tr>
</table>
<br>
...
<table class="List_Table" border="1" width="100%">
	...
	<tr class="Result1">
		<td align="right">1</td>
		<td align="left"><a href="#" onClick="returnValue=Array({$var.row0});window.close();">00000001</a></td>
	...
	<tr class="Result1">
		<td align="right">2</td>
		<td align="left"><a href="#" onClick="returnValue=Array({$var.row1});window.close();">00000002</a></td>
	...
	<tr class="Result1">
		<td align="right">3</td>
		<td align="left"><a href="#" onClick="returnValue=Array({$var.row2});window.close();">00000003</a></td>
	...
	<tr class="Result1">
		<td align="right">4</td>
		<td align="left"><a href="#" onClick="returnValue=Array({$var.row3});window.close();">00000004</a></td>
	...
	<tr class="Result1">
		<td align="right">5</td>
		<td align="left"><a href="#" onClick="returnValue=Array({$var.row4});window.close();">00000005</a></td>
