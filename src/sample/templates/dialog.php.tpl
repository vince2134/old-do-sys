...
<col width="225">
	...
	<tr>
		<td class="Title_Pink" width="100"><b>受注日<font color="red">※</font></b></td>
	...
	<tr>
		<td class="Title_Pink"><b><a href="javascript:Sub_Window_Open('customer.php')">得意先</a><font color="red">※</font></b></td>
	...
	<tr>
		<td class="Title_Pink" width="100"><b><a href="javascript:Sub_Window_Open('warehouse.php')">出荷倉庫</a><font color="red">※</font></b></td>
	...
	<tr>
		<td class="Title_Pink" width="100"><b><a href="javascript:Sub_Window_Open('dealing.php')">取引区分</a><font color="red">※</font></b></td>
		<td class="Value" colspan="3">{$form.f_dealing.html}</td>
	</tr>
	
	<tr>
		<td class="Title_Pink" width="100"><b><a href="javascript:Sub_Window_Open('charge.php')">担当者</a><font color="red">※</font></b></td>
...
<table class="List_Table" border="1" width="100%">
	<tr class="Result1" align="center">
		...
		<td class="Title_Pink" width=""><b>受注数<font color="red">※</font></b></td>
		<td class="Title_Pink" width="90"><b>単位</b></td>
		<td class="Title_Pink" width=""><b>原価単価<font color="red">※</font><br>売上単価<font color="red">※</font></b></td>
		<td class="Title_Pink" width=""><b>原価金額<font color="red">※</font><br>売上金額<font color="red">※</font></b></td>
	...
	<tr class="Result1">
		<td align="right">1</td>
		<td align="left">{$form.f_goods1.html}（<a href="javascript:Sub_Window_Open('goods1.php','goods1')">検索</a>）<br>{$form.t_goods1.html}</td>
	...
	<tr class="Result1">
		<td align="right">2</td>
		<td align="left">{$form.f_goods2.html}（<a href="javascript:Sub_Window_Open('goods1.php','goods2')">検索</a>）<br>{$form.t_goods2.html}</td>
		<td align="center">{$form.f_text9.html}</td>
		<td align="left">個</td>
	...
	<tr class="Result1">
		<td align="right">3</td>
		<td align="left">{$form.f_goods3.html}（<a href="javascript:Sub_Window_Open('goods1.php','goods3')">検索</a>）<br>{$form.t_goods3.html}</td>
		<td align="center">{$form.f_text9.html}</td>
		<td align="left">個</td>
	...
	<tr class="Result1">
		<td align="right">4</td>
		<td align="left">{$form.f_goods4.html}（<a href="javascript:Sub_Window_Open('goods1.php','goods4')">検索</a>）<br>{$form.t_goods4.html}</td>
		<td align="center">{$form.f_text9.html}</td>
		<td align="left">個</td>
...
<table width="100%">
	<tr>
		<td align="left">
			<b><font color="red">※は必須入力です</font></b>
		</td>
