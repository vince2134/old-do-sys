...
//マルチバイトの文字数チェック
$form->registerRule("php_check_rule","function","sample_func");
function sample_func($val1,$val2,$val3) {
  return $val3;
} 
//内容チェック
$form->addRule( "nick_name", "ニックネームを入力して下さい。", "required");
$form->addRule( "nick_name", "ニックネームは全角で1から10文字までです。",  "php_check_rule",false);
/*
//空文字チェック
...
function mb_maxlength($val1,$val2,$val3) {
...
から50文字までです。", "rangelength", array(1,50),"client");
...
メールアドレスとメールアドレス確認が一致しません。","compare", NULL, "client");
*/
//エラーメッセージを日本語設定に変更
