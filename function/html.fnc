 ...
 *
 */
function Html_Header($html_title="", $js="amenity.js", $css="global.css", $css2="", $compatible="") {

    $charset  = HTML_CHAR;
    $css_file = CSS_DIR ."$css";
    $js_file  = JS_DIR ."$js";
    $favicon  = IMAGE_DIR ."favicon.ico";
    if ("" == $compatible) $meta_compatible = '';
    else $meta_compatible = '<meta http-equiv="X-UA-Compatible" content="IE=8">';
    if($css2 != ""){
